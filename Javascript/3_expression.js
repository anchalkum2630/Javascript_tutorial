...
//! var result = 0.1 + 0.2 ❓ 🤔💭
// var result = 0.1 + 0.2;
// console.log(result.toFixed(2)); //without tofixed->0.3000000000004 because computer understand binary..fixed fix the digit after decimal
...
// console.log(2 < 12 < 5);  (true<5)->true=1
