...
// console.log(text.indexOf("thapa"));//-1 because not able to find
// //The indexOf() method is case sensitive.
// console.log(text.indexOf("Thapa"));//output ->6
...
//   console.log(pangramChecker("The quick  @ brown fox jumps ove the lazy dog"));k